...
var $author$project$MainSpec$loaderTest = A2(
	...
	_List_fromArray(
		[
			A2(
			$elm_explorations$test$Test$test,
			'Shows loader when no data is available',
			function (_v0) {
				return A2(
			...
			A2(
			$elm_explorations$test$Test$test,
			'Does not show loader when data is available',
			function (_v1) {
				return A2(
...
var $author$project$MainSpec$workoutListTest = A2(
	...
	_List_fromArray(
		[
			A2(
			$elm_explorations$test$Test$test,
			'Shows workout list when data is available',
			function (_v0) {
				return A2(
					$elm_explorations$test$Test$Html$Query$has,
					_List_fromArray(
						[
							$elm_explorations$test$Test$Html$Selector$text('mockWorkout')
						]),
					A2(
						$elm_explorations$test$Test$Html$Query$find,
						_List_fromArray(
...
var $author$project$Test$Generated$Main1720793814$main = A2(
...
_Platform_export({'Test':{'Generated':{'Main1720793814':{'init':$author$project$Test$Generated$Main1720793814$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-33113.sock";
