...
{
	if (region.ad.K === region.aq.K)
	{
		return 'on line ' + region.ad.K;
	}
	return 'on lines ' + region.ad.K + ' through ' + region.aq.K;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.bl, request.ah, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {as: fragment, ax: host, aG: path, aI: port_, aL: protocol, aM: query};
	});
...
var $author$project$Page$Home$GotWorkouts = function (a) {
	return {$: 1, a: a};
};
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{a5: false, ak: r.ak, X: r.X, av: r.av, bl: r.bl, bI: r.bI, a_: r.a_, ah: r.ah}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{ak: $elm$http$Http$emptyBody, X: r.X, av: _List_Nil, bl: 'GET', bI: $elm$core$Maybe$Nothing, a_: $elm$core$Maybe$Nothing, ah: r.ah});
};
var $elm$json$Json$Decode$list = _Json_decodeList;
var $author$project$Api$Workout = function (name) {
	return {aC: name};
};
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Api$workoutDecoder = A2(
	$elm$json$Json$Decode$map,
	$author$project$Api$Workout,
	A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string));
var $author$project$Api$workoutListDecoder = $elm$json$Json$Decode$list($author$project$Api$workoutDecoder);
var $author$project$Api$getWorkouts = function (msg) {
	return $elm$http$Http$get(
		{
			X: A2($elm$http$Http$expectJson, msg, $author$project$Api$workoutListDecoder),
			ah: $author$project$Api$baseUrl + '/workouts'
		});
};
var $author$project$Page$Home$init = _Utils_Tuple2(
	{C: '', E: $elm$core$Maybe$Nothing},
	$author$project$Api$getWorkouts($author$project$Page$Home$GotWorkouts));
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Page$Login$init = function (navKey) {
...
var $author$project$Main$initCurrentPage = function (_v0) {
	...
	var _v1 = function () {
		...
		switch (_v2) {
			case 1:
				var _v3 = $author$project$Page$Login$init(model.S);
				var loginModel = _v3.a;
				var loginCmds = _v3.b;
				return _Utils_Tuple2(
					$author$project$Main$LoginPage(loginModel),
					A2($elm$core$Platform$Cmd$map, $author$project$Main$LoginPageMsg, loginCmds));
			case 2:
				var _v4 = $author$project$Page$Home$init;
				var homeModel = _v4.a;
				var homeCmds = _v4.b;
				return _Utils_Tuple2(
					$author$project$Main$HomePage(homeModel),
					A2($elm$core$Platform$Cmd$map, $author$project$Main$HomePageMsg, homeCmds));
			default:
...
var $elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {y: frag, A: params, x: unvisited, t: value, D: visited};
	});
...
var $author$project$Main$init = F3(
	function (flags, url, key) {
		var model = {
			S: key,
			z: $author$project$Main$NotFoundPage,
			U: $author$project$Route$parseUrl(url)
		};
...
var $author$project$Page$Home$AddWorkout = function (a) {
	return {$: 3, a: a};
};
...
var $elm$http$Http$post = function (r) {
	return $elm$http$Http$request(
		{ak: r.ak, X: r.X, av: _List_Nil, bl: 'POST', bI: $elm$core$Maybe$Nothing, a_: $elm$core$Maybe$Nothing, ah: r.ah});
};
...
var $author$project$Api$workoutEncoder = function (workout) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'name',
				$elm$json$Json$Encode$string(workout.aC))
			]));
};
var $author$project$Api$addWorkout = F2(
	function (msg, workout) {
		return $elm$http$Http$post(
			{
				ak: $elm$http$Http$jsonBody(
					$author$project$Api$workoutEncoder(workout)),
				X: $elm$http$Http$expectWhatever(msg),
				ah: $author$project$Api$baseUrl + '/workouts'
			});
	});
...
var $author$project$Page$Home$update = F2(
	function (action, model) {
		switch (action.$) {
			...
			case 2:
				var key = action.a;
				return _Utils_eq(key, $author$project$Page$Home$enterKey) ? _Utils_Tuple2(
					model,
					A2(
						$author$project$Api$addWorkout,
						$author$project$Page$Home$AddWorkout,
						{aC: model.C})) : _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			default:
				if (!action.a.$) {
					var res = action.a.a;
					var _v1 = model.E;
...
var $author$project$Page$Login$errorToString = function (err) {
	if ((err.$ === 3) && (err.a === 401)) {
		return 'The email or password are incorrect, please try again.';
	} else {
		return 'An unknown error occured';
	}
};
var $author$project$Api$credEncoder = function (cred) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'email',
				$elm$json$Json$Encode$string(cred.ap)),
				_Utils_Tuple2(
				'password',
				$elm$json$Json$Encode$string(cred.aF))
			]));
};
		...
		return $elm$http$Http$post(
			{
				...
				X: $elm$http$Http$expectWhatever(msg),
				ah: $author$project$Api$baseUrl + '/auth/login'
			});
	});
				...
				if (!msg.a.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{G: ''}),
						A2($author$project$Route$pushUrl, 2, model.S));
				} else {
					var err = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								G: $author$project$Page$Login$errorToString(err)
							}),
						$elm$core$Platform$Cmd$none);
				}
		}
			...
			switch (_v0.a.$) {
				case 0:
					if (_v0.b.$ === 2) {
						...
						var _v1 = A2($author$project$Page$Home$update, homeMsg, homeModel);
						var updatedHomeModel = _v1.a;
						var updatedCmd = _v1.b;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									z: $author$project$Main$HomePage(updatedHomeModel)
								}),
				...
				case 1:
					if (_v0.b.$ === 1) {
						...
						var _v2 = A2($author$project$Page$Login$update, loginMsg, loginModel);
						var updatedLoginModel = _v2.a;
						var updatedCmd = _v2.b;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									z: $author$project$Main$LoginPage(updatedLoginModel)
								}),
...
var $author$project$Card$card = function (workout) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(workout.aC)
					]))
			]));
};
var $elm$html$Html$h1 = _VirtualDom_node('h1');
var $elm$html$Html$input = _VirtualDom_node('input');
var $author$project$Loader$loader = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('loader-container')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('inner-loader')
				]),
			_List_Nil)
		]));
	...
	return A2(
		...
		function () {
			...
			if (!_v0.$) {
						...
						_List_fromArray(
							[
								...
								A2(
									$elm$core$List$map,
									function (workout) {
										return $author$project$Card$card(workout);
									},
									workouts))
							]))
					]);
				...
				return _List_fromArray(
					[$author$project$Loader$loader]);
			}
		}());
};
var $author$project$Page$Login$EmailChange = function (a) {
	return {$: 1, a: a};
};
var $author$project$Page$Login$OnLogin = {$: 0};
var $author$project$Page$Login$PasswordChange = function (a) {
	return {$: 2, a: a};
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Welcome to Workouts')
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								(model.G !== '') ? $elm$html$Html$Attributes$class('login-error-active') : $elm$html$Html$Attributes$class('login-error-inactive')
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onInput($author$project$Page$Login$EmailChange),
								$elm$html$Html$Attributes$value(model.ap),
								$elm$html$Html$Attributes$placeholder('Enter email...')
							]),
						_List_Nil),
						A2(
						$elm$html$Html$input,
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$class('login-input'),
								$elm$html$Html$Events$onInput($author$project$Page$Login$PasswordChange),
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onClick($author$project$Page$Login$OnLogin)
							]),
						_List_fromArray(
							[
...
var $author$project$Main$viewer = function (model) {
	var _v0 = model.z;
	switch (_v0.$) {
		case 0:
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Oopsie looks like a 404!')
					]));
		case 1:
...
var $author$project$Main$view = function (model) {
	return {
		ak: _List_fromArray(
			[
				$author$project$Main$viewer(model)
			]),
		bJ: 'Workouts BO'
	};
};
var $author$project$Main$main = $elm$browser$Browser$application(
	{bk: $author$project$Main$init, bv: $author$project$Main$UrlChanged, bw: $author$project$Main$LinkClicked, bF: $author$project$Main$subscriptions, bK: $author$project$Main$update, bL: $author$project$Main$view});
