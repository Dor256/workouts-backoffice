...
var $author$project$MainTest$buttonPress = A2(
				...
				return A2(
					...
					A2(
						...
						A2(
							...
							_List_fromArray(
								[
									$elm_explorations$test$Test$Html$Selector$class('button')
								]),
							$elm_explorations$test$Test$Html$Query$fromHtml(
								$author$project$Main$view(
									{search: '', title: 'Title', workouts: _List_Nil})))));
			})
		]));
...
var $author$project$MainTest$inputType = A2(
	$elm_explorations$test$Test$describe,
	'Input',
	_List_fromArray(
		[
...
var $author$project$Test$Generated$Main1072665130$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		globs: _List_Nil,
		paths: _List_fromArray(
			['/Users/dor/Workspace/workouts-backoffice/tests/MainTest.elm']),
		processes: 12,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 311103870849156
	},
...
_Platform_export({'Test':{'Generated':{'Main1072665130':{'init':$author$project$Test$Generated$Main1072665130$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-9446.sock";
